...
public class ActivateSubsOnViewedMeTest {
    ...
    @Test
    public void actSubViewedmeTest() {
        ...
        PeopleNearbyPage.pn_ham_viewedMe(driver).click();
        assertThat(ActivateSubscriptionPage.as_getFullAccessText(driver).getText(), is(ApplicationTexts.getFullAccessText(toString())));
        assertThat(ActivateSubscriptionPage.as_seeWhoViewedYouText(driver).getText(), is(ApplicationTexts.seeWhoViewedYou(toString())));
        assertThat(ActivateSubscriptionPage.as_keepAnEyeOnThePeopleText(driver).getText(), is(ApplicationTexts.keepAnEyeOntheProfile(toString())));
        ...
        System.out.println("===============================Checking Activate Subscription page on ViewedMe successful=============================");
