...
public class ActivateSubsOnFavedMe {
    ...
    public void actSubFavedTest() {
        ...
        PeopleNearbyPage.pn_ham_favedMe(driver).click();
        ...
        System.out.println("===============================Checking Activate Subscription page on FavedMe successful=============================");
