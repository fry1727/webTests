...
public class PNChat {
    ...
    @Test
    public void activateSubstciption_QMLikedMe() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//div[1]//div[2]//button[1]")).click();                                                                                                    //нажимаем на кнопку чата у первого юзера в колоде
