...
public class FavedMeTest {
    ...
    @Test
    public void activateSubstciption_FavedMe() throws InterruptedException {
        ...
        new WebDriverWait(driver, 5).until(ExpectedConditions.elementToBeClickable(By.xpath("//span[contains(text(),'Faved Me')]")));
        driver.findElement(By.xpath("//span[contains(text(),'Faved Me')]")).click();
